        ...
        <div class="card border-danger mb-4">
            <div class="card-body">
                ...
                <form method="post" action="{{ route('user.update') }}">
                    @method('put')
                    @csrf
                    <input type="text" name="name" class="form-control mb-2" value="{{ $user['name'] }}" placeholder="Nome">
                    <textarea name="bio" rows="3" class="form-control mb-3" value="{{ $user['bio'] }}" placeholder="Bio"></textarea>
